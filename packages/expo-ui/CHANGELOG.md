...
- [android] Added `Anchor` slot, `readOnly`, `enabled`, and `TrailingIcon` slot to `TextInput`, and renamed `ExposedDropdownMenuPicker` to `ExposedDropdownMenuBox` with customizable anchor support. ([#44201](https://github.com/expo/expo/pull/44201) by [@vonovak](https://github.com/vonovak))
- [android] new `ExposedDropdownMenuBox` Android primitive. ([#44058](https://github.com/expo/expo/pull/44058) by [@vonovak](https://github.com/vonovak))
