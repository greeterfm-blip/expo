...
data class ExposedDropdownMenuBoxProps(
  ...
  val menuContainerColor: Color? = null,
...
fun FunctionalComposableScope.ExposedDropdownMenuBoxContent(
  ...
  ExposedDropdownMenuBox(
    ...
    ExposedDropdownMenu(
      expanded = props.expanded,
      onDismissRequest = { if (props.enabled) onExpandedChange(false) },
      containerColor = props.menuContainerColor.composeOrNull ?: MenuDefaults.containerColor
    ) {
