  ...
  return (
    <Page>
      ...
      <Section title="Disabled">
        <Host matchContents>
          <ExposedDropdownMenuBox expanded={false} enabled={false}>
            <ExposedDropdownMenuBox.Anchor>
      ...
      <Section title="Custom anchor">
        <Host matchContents>
          <ExposedDropdownMenuBox expanded={expanded3} onExpandedChange={setExpanded3}>
            <ExposedDropdownMenuBox.Anchor>
              <ComposeText modifiers={[fillMaxWidth(0.5), background('#e0e7ff')]}>
      ...
      <Section title="Custom menu color">
        <Host matchContents>
          <ExposedDropdownMenuBox
            expanded={expanded4}
            onExpandedChange={setExpanded4}
            menuContainerColor="lightblue">
            <ExposedDropdownMenuBox.Anchor>
